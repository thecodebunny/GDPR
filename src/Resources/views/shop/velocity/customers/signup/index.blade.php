        ...
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                ...
                <div class="body col-12">
                    ...
                    {!! view_render_event('thecodebunny.shop.customers.signup.before') !!}
                    ...
                    <form
                        ...
                        {!! view_render_event('thecodebunny.shop.customers.signup_form_controls.before') !!}
                        ...
                        {!! view_render_event('thecodebunny.shop.customers.signup_form_controls.firstname.after') !!}
                        ...
                        {!! view_render_event('thecodebunny.shop.customers.signup_form_controls.lastname.after') !!}
                        ...
                        {!! view_render_event('thecodebunny.shop.customers.signup_form_controls.email.after') !!}
                        ...
                        {!! view_render_event('thecodebunny.shop.customers.signup_form_controls.password.after') !!}
                        ...
                        <?php
                        $gdprRepository = app('Thecodebunny\GDPR\Repositories\GDPRRepository');
                        ...
                        {!! view_render_event('thecodebunny.shop.customers.signup_form_controls.after') !!}
                    ...
                    {!! view_render_event('thecodebunny.shop.customers.signup.after') !!}
                </div>
            </div>
        </div>
    </div>
